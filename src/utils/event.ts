...
export const CONSTANT = (<any>Object).assign({}, USER, TABLECONFIG, ORGANIZATION, MYWEBSITEEVENT, NOTICEEVENT, LOGADUITEVENT, ROUTEREVENT, WEBSITEANALYSISEVENT, REPORTEVENT);
/**
 *Author wjt
 *Date 2017-12-26
 *Note 通知服务
